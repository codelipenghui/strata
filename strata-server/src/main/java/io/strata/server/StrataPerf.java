...
final class StrataPerf {
    ...
    static void run(String[] argv) throws Exception {
        ...
        log.info("perf: meta={} workload={} recordSize={}B files={} window={} duration={}s fsync={}",
                meta, workload, recordSize, files, window, durationSec, fsync);

        try (StrataClient client = StrataClient.connect(ClientConfig.of(meta).withChunkRollBytes(64L << 20))) {
