    ...
    public Frame handle(Frame req) throws Exception {
        ...
        return switch (op) {
            ...
            case READ -> {
                ...
                // Bytes were materialized by ChunkStore: OPEN chunks need a stable snapshot across
                // seal-truncate, and SEALED chunks need range-CRC verification before serving.
                byte[] bytes = r.bytes();
